...
function move(id){
	...
	if( target_d != 0){
		...
		stepcount++;
		document.getElementById("counter").innerHTML="总步数  "+stepcount;
	}
	...
	if(finish_flag==true){
		document.title = "我用了"+stepcount+"步完成了拼图";
		document.getElementById("message").innerHTML="您用了"+stepcount+"步就完成了拼图，是厉害！要不要分享一下？";
	}
}
